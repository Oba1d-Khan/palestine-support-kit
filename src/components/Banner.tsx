...
const Banner: React.FC<BannerProps> = ({ variant }) => {
    ...
    return (
        <div className={`container p-4 text-center relative flex items-center justify-center gap-6 overflow-hidden ${containerClasses}`}>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 filter blur-xl w-full h-full opacity-30 z-0 bg-gradient-to-r from-red-500 to-green-500"></div>
            <div className="content flex items-center gap-3 z-10">
                <p className="text-lg font-medium flex items-center">
                    <img src="./Flag_of_Palestine.png" alt="Palestine Flag" className="w-8 h-5 mx-2" />
